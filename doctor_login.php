...
<body style="background:url('images/doctorportal.jpg') no-repeat; background-size:cover; opacity: 1; margin-top:15px">
...
<div class="card-body">
    <form class="form-group" action="func.php" method="post" onsubmit="return validateform()">
      ...
      <input type="submit" name="doctor_login_submit" class="btn btn-success" style="margin-left: 10px;" >
